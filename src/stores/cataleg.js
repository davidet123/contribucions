...
export const useCatalegStore = defineStore('cataleg', () => {
  ...
  const equips = ref(storage.get('equips') || [
    ...
    { id: uuidv4(), nom: 'MAKITO 21', tipusId: 'makito_rx', notes: '' },
    { id: uuidv4(), nom: 'MAKITO 22', tipusId: 'makito_rx', notes: '' },
    { id: uuidv4(), nom: 'MAKITO 23', tipusId: 'makito_rx', notes: '' },
    { id: uuidv4(), nom: 'MAKITO 24', tipusId: 'makito_rx', notes: '' },
